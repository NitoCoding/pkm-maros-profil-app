...
export default function GeografiPage() {
	return (
		<>
			<PageHead 
				title="Geografi Kelurahan Bilokka"
				description="Informasi geografis dan kondisi wilayah Kelurahan Bilokka"
				keywords="geografi, wilayah, kelurahan, bilokka"
			/>
									...
									<div className="p-4 sm:p-6">
										<div className="flex justify-between items-center mb-4">
											<div className="flex items-center gap-2">
												...
												<h1 className="text-xl sm:text-2xl font-bold">Data Geografi</h1>
											</div>
										</div>
										...
										<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
											...
											<div className="space-y-4">
												<div className="bg-teal-50 p-4 rounded-lg border border-teal-200">
													<div className="text-2xl font-bold text-teal-600">{geografi.luasWilayah} Ha</div>
													<div className="text-sm text-gray-600">Luas Wilayah</div>
												</div>
												
												<div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
													<div className="text-2xl font-bold text-blue-600">{geografi.jumlahDusun}</div>
											...
											<div className="space-y-4">
												...
												<div className="space-y-2">
													{geografi.penggunaanLahan && Object.entries(geografi.penggunaanLahan).map(([key, value]) => (
												...
												<div className="space-y-2">
													...
													<p className="text-sm text-gray-600">{geografi.kondisiGeografis}</p>
												</div>

												<div className="space-y-2">
													<h3 className="font-semibold text-gray-800">Potensi Alam</h3>
													<p className="text-sm text-gray-600">{geografi.potensiAlam}</p>
												</div>
											</div>
										</div>
									</div>
