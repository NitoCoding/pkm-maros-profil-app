  ...
  const onSubmit = async (data: InovasiFormValues) => {
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Gagal menyimpan inovasi')
      }

      toast.success('Inovasi berhasil ditambahkan!')
      router.push('/admin/inovasi')
    } catch (error: any) {
      const errorMessage = error instanceof Error ? error.message : 'Terjadi kesalahan saat menyimpan inovasi'
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Tambah Inovasi Baru</h1>
          <p className="text-gray-600">Daftarkan inovasi desa terbaru</p>
        </div>
      </div>
